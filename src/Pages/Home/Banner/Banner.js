      ...
      <div>
        <div className="relative -mt-8">
          ...
          <div className="absolute top-52 text-white left-16 text-start w-1/2">
            ...
            <button
              type="button"
              class="text-white mt-3 bg-[#FF9119] hover:bg-[#FF9119]/80 focus:ring-4 focus:ring-[#FF9119]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 mr-2 mb-2"
            >
              LEARN MORE
            </button>
          </div>
