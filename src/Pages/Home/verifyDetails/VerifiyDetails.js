          ...
          <div className="container flex flex-col-reverse mx-auto items-center lg:flex-row">
            ...
            <div className="flex flex-col w-full   py-8 space-y-6 rounded-sm sm:p-8 lg:p-12  dark:bg-violet-400 dark:text-gray-900">
              ...
              <div className="flex space-x-2 text-start sm:space-x-4">
                ...
                <div className="space-y-2">
                  <p className="text-lg font-medium leadi">
                    Scan passports, driver licenses, identity cards from over
                    190 countries.
                  </p>
                </div>
              </div>
              ...
              <div className="flex space-x-2 text-start sm:space-x-4">
                ...
                <div className="space-y-2">
                  <p className="text-lg font-medium leadi">
                    Verify personal data, including given names, surname, date
                    of birth, age, document expiry, residential address,
                    postcode, document number, nationality and more!
                  </p>
                </div>
              </div>
              <div className="flex space-x-2 text-start sm:space-x-4">
