...
import verifyImg from "../../../assets/feature-img-verify.png";
      ...
      <section className="dark:bg-white dark:text-gray-100">
        <div className="container flex flex-col-reverse mx-auto items-center lg:flex-row">
          <div className=" dark:bg-white w-3/4">
            <div className="">
              <img
                src={verifyImg}
                alt=""
                className=" h-screen  aspect-video sm:min-h-96"
              />
            </div>
          </div>
          <div className="flex flex-col w-full   py-8 space-y-6 rounded-sm sm:p-8 lg:p-12  text-gray-900">
            ...
            >
              ON-PREMISE KYC SOLUTION
            </button>
            <h1 className="text-3xl font-bold text-start">
              ID Fort e-KYC WEB Software
            </h1>
            <div className="flex space-x-2 text-start sm:space-x-4">
              <svg
              ...
              <div className="space-y-2">
                <p className="text-lg font-medium leadi">
                  Scan passports, driver licenses, identity cards from over 190
                  countries.
                </p>
              </div>
            </div>
            ...
            <div className="flex space-x-2 text-start sm:space-x-4">
              ...
              <div className="space-y-2">
                <p className="text-lg font-medium leadi">
                  Verify personal data, including given names, surname, date of
                  birth, age, document expiry, residential address, postcode,
                  document number, nationality and more!
                </p>
              </div>
            </div>
            <div className="flex space-x-2  text-start sm:space-x-4">
              ...
              <div className="space-y-2">
                <p className="text-lg font-medium leadi">
                  Biometric facial recognition to verify a person's photo or
                  video against identity documents.
                </p>
              </div>
            </div>
            <div className="flex space-x-2 text-start sm:space-x-4">
