          ...
          <div class="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
            <ul class="grid gap-4 mt-8 sm:grid-cols-2 lg:grid-cols-3">
              <div class="relative block overflow-hidden rounded-lg border border-gray-100 p-4 sm:p-6 lg:p-8">
                ...
                <div class="mt-4">
                  <p class="max-w-[40ch] text-sm text-gray-500">
                    Identify passports, driver licence and ID cards from over
                    190 countries, with or without MRZ and barcode.
                  </p>
                </div>
              </div>
              ...
              <div class="relative block overflow-hidden rounded-lg border border-gray-100 p-4 sm:p-6 lg:p-8">
                ...
                <div class="mt-4">
                  <p class="max-w-[40ch] text-sm text-gray-500">
                    Proprietary deep learning models to provide the best
                    accuracy of all ID scanners and validators.
                  </p>
                </div>
              </div>
